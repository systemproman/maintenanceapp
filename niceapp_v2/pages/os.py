...
from auth import can_edit, can_close_os, can_delete, is_admin
...
def os_page():
    editavel = can_edit()          # Gerência + Admin
    pode_encerrar = can_close_os() # Somente Admin
    pode_excluir = can_delete()    # Somente Admin

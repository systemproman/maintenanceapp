...
# Carrega .env com caminho absoluto (funciona independente do working directory)
_BASE_DIR_SETTINGS = Path(__file__).resolve().parent.parent
_DOTENV_PATH = _BASE_DIR_SETTINGS / '.env'
load_dotenv(dotenv_path=_DOTENV_PATH, override=False)  # override=False: env vars do sistema (Render) têm prioridade
